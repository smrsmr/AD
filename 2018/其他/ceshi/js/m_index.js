(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
        app = new Vue({
            ...
            computed:{
                qrcodeUrl:function(){
                    return 'https://ceshi/activity/dist/2018-autumn/m_index.html'
                },
                createCode:function(){
            ...
            methods:{
                        ...
                        success: function(data) {
                            ...
                            if (data.state == 200 && data.content) { // 已登录
                                ...
                                if((!getQueryString('selected') && !param) || (!param && getQueryString('selected') && !localStorage.getItem('2018-employer'))){
                                    ...
                                    window.location.href = 'https://ceshi/activityapi/weixin/userInfoAuth.html?returnUrl=' + encodeURIComponent(href);
                                }
                            }
                        },
                ...
                getOffer:function(){
                    window.location.href = 'https://ceshi/topic/2018qz.html';
                }
            }
        })
    },{}]},{},[1]);